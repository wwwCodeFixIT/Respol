...
text
    ...
    <div className="text-center mb-12 lg:mb-16">
      ...
      <a 
        ...
        target="_blank" 
        rel="noopener noreferrer"
        className="inline-flex items-center gap-4 bg-white border border-gray-100 shadow-sm hover:shadow-md rounded-full px-6 py-3 transition-all duration-300 group text-decoration-none"
      >
