      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-6 lg:gap-8 items-stretch">
          ...
          >
            ...
            {/* B2B Image - removed as requested */}
          ...
          <div className="flex flex-col gap-6">
            {/* SLIDER - zachowuje proporcje banerów 782:258 (około 3:1) */}
            <div 
            ...
            >
              ...
              {/* Slider controls - widoczne przy hover */}
              <button
  ...
  const reviews = useMemo(
    () => [
      ...
      },
      {
        name: "Marcin Dudek",
        date: "2025-06-04",
        text: "Jestem drugi raz w tym sklepie i jestem pod wrażeniem obsługi i asortymentu. Fachowej wiedzy sprzedawców. Serdecznie polecam.",
      ...
      },
      {
        name: "Roman Żuk",
        date: "2025-06-04",
        text: "Dzięki profesjonalnej pomocy i nieograniczonego asortymentu hurtowni Pan Jerzy dopasował mi część idealnie.",
  ...
  return (
    <section className="py-16 lg:py-24 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Header */}
        <div className="text-center mb-12 lg:mb-16">
          <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-6">Opinie naszych klientów</h2>
          <div className="inline-flex items-center gap-4 bg-white rounded-full px-6 py-3 border border-gray-200 shadow-sm">
            ...
            <img src="https://cdn.trustindex.io/assets/platform/Google/logo.svg" alt="Google" className="h-5" />
          </div>
        </div>
            ...
            >
              <div className="flex items-center justify-between mb-5">
                <div className="flex items-center gap-3">
                  <img src={r.avatar} alt={r.name} className="w-12 h-12 rounded-full object-cover ring-2 ring-gray-100" />
                  <div>
        ...
        <div className="mt-12 text-center">
          <a
            href="https://www.google.com/maps/search/Respol+Hurtownia"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-3 bg-white border border-gray-200 hover:border-gray-300 hover:shadow-lg px-6 py-3.5 rounded-xl font-semibold text-gray-700 transition-all"
          >
            <img src="https://cdn.trustindex.io/assets/platform/Google/logo.svg" alt="Google" className="h-5" />
